...
public final class FingerPrint {
    ...
    public static void main(String[] args) throws IOException {
        FingerPrint fp1 = new FingerPrint(ImageIO.read(new File("D:\\Photo\\mjorcen.normal.exp0.png")));
        FingerPrint fp2 =new FingerPrint(ImageIO.read(new File("D:\\Photo\\20180204214521.png")));
